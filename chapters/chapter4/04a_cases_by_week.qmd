...
ca_cases_week_pnts <- ca_cnty_pnts %>%
  left_join(cnty_week_data, by = c("county")) %>%
  st_transform(4326)
...
##-st_write(ca_cases_week_pnts, here("data/shapefiles/ca_cases_week_pnts/ca_cases_week_pnts.shp"))
