...
# final cleaned dataframes stored in "data/cleaned_data/" directory

#--write.csv(combined_df, file = here("data/cleaned_data/combined_df.csv"), row.names = FALSE)
#--write.csv(ca_df, file = here("data/cleaned_data/cleaned_ca_df.csv"), row.names = FALSE)
#--write.csv(la_cnty_df, file = here("data/cleaned_data/cleaned_la_cnty_df.csv"), row.names = FALSE)
#--write.csv(pop_df, file = here("data/cleaned_data/cleaned_pop_df.csv"), row.names = FALSE)
