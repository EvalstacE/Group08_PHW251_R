...
raw_ca_df <- read.csv(file = here("data/raw_data/raw_ca_df.csv"))
raw_la_cnty_df <- read.csv(file = here("data/raw_data/raw_la_cnty_df.csv"))
raw_pop_df <- read.csv(file = here("data/raw_data/raw_pop_df.csv"))
...
![](../../www/cleaned_col_tbl.png){width="75%"}
