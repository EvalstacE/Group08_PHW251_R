...
step1_ca_df <- read.csv(file = here("data/tbl_outputs_03/step1_ca_df.csv"))
step1_la_cnty_df <- read.csv(file = here("data/tbl_outputs_03/step1_la_cnty_df.csv"))
step1_pop_df <- read.csv(file = here("data/tbl_outputs_03/step1_pop_df.csv"))
