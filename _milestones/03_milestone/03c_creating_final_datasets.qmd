...
step2_ca_df <- read.csv(file = here("step2_tbl_outputs/step2_ca_df.csv"))
step2_la_cnty_df <- read.csv(file = here("step2_tbl_outputs/step2_la_cnty_df.csv"))
step2_pop_df <- read.csv(file = here("step2_tbl_outputs/step2_pop_df.csv"))
