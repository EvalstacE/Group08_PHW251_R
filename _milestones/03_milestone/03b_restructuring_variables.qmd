...
step1_ca_df <- read.csv(file = here("step1_tbl_outputs/step1_ca_df.csv"))
step1_la_cnty_df <- read.csv(file = here("step1_tbl_outputs/step1_la_cnty_df.csv"))
step1_pop_df <- read.csv(file = here("step1_tbl_outputs/step1_pop_df.csv"))
